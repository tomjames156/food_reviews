...
const restaurants_info = [
    ...
    { restaurant_name: 'PapaRimz Pizza', review: `Papa Rimz is an underrated food vendor with awesome stuff. They sell things like milkshakes, Chinese rice, shawarma, and spaghetti. Everything is good and reliable. My favourite thing to get from them is literally any type of rice because it's the rice reminiscent of a Chinese restaurant. They should work on their outdoor aesthetics though.`, rating: 4.5, image_info:['paparimz.jpeg', 'pizza in a box with ginger drink and chicken side'], reviews_list: [0, 9.7, 10, 10]},
